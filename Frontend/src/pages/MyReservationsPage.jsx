      ...
      <main className="my-res-wrap">
        <div className="my-res-header">
          <div>
            ...
            <p className="my-res-sub">
              All stays you have booked are listed here.
            </p>
          </div>
          <Link to="/listings" className="my-res-browse">
            Browse more stays
          </Link>
        </div>
        ...
        {cancelMsg && (
          <div
            className={`res-toast ${cancelMsg.includes("cancelled") ? "res-toast--success" : "res-toast--error"}`}
          >
            {cancelMsg}
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="my-res-empty">
            ...
            <Link to="/listings" className="my-res-empty__btn">
              Start exploring
            </Link>
          </div>
        ) : (
                  ...
                  <div className="res-card__body">
                    <div className="res-card__top">
                      <div>
                        ...
                        <h3 className="res-card__title">
                          <Link to={`/listings/${acc._id}`}>
                            {acc.title || "Your reservation"}
                          </Link>
                        </h3>
                        <p className="res-card__loc">
                          📍 {acc.location || "South Africa"}
                        </p>
                      </div>
                      <span className={`res-status ${status.cls}`}>
                        {status.label}
                      </span>
                    </div>
                    ...
                    <div className="res-card__dates">
                      <div className="res-card__date-block">
                        ...
                        <span className="res-card__date-value">
